...
import { Receipt, Search, ArrowUpDown, Download, ShoppingBag, Calendar } from 'lucide-react';
...
const Orders = () => {
    ...
    const exportCSV = () => {
        ...
        const rows = filtered.map(s => [
            s.product_name, s.barcode, s.quantity_sold, s.total_price,
        ...
        a.href = url; a.download = `smarttrack_sales_${new Date().toISOString().split('T')[0]}.csv`;
        a.click();
        ...
        <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <button onClick={exportCSV} style={{
                    ...
                    background: 'var(--bg-card)', color: 'var(--text-secondary)', padding: '10px 20px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <div style={{
                    ...
                    borderRadius: 'var(--radius-md)', padding: '8px 14px', flex: 1, maxWidth: '360px'
                }}>
                    ...
                    <tbody>
                        {filtered.map(sale => (
                            <tr key={sale.id} className="table-row-hover" style={{ borderBottom: '1px solid var(--border-light)' }}>
                                ...
                                <td style={tdStyle}>
                                    <span style={{ background: 'var(--bg-input)', padding: '2px 10px', borderRadius: '6px', fontSize: '13px', fontWeight: 600 }}>
                                        {sale.quantity_sold}
                                    </span>
                                </td>
